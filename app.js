...
const KEY = '20270679-e2ac60542aff7a13daf556a57';
...
const searchHistory = (searchItems) => {
  const searchList = document.getElementById("historyBox");
  searchList.innerText = ``;
  for(let i=0; i<searchItems.length; i++) {
    const listItem = searchItems[i];
